<?php 
    ...
    function DA_custom_wp_block_patterns() {
        ...
        register_block_pattern(
            'dough/date del corso',
            array(
                'title'       => __( 'Date del corso', 'date_corso' ),
                
                'description' => _x( 'Parte finale dei corsi in cui si vuole mostrare le date', 'dough' ),
                
                'content'     => "<!-- wp:group -->\r\n<div class=\"wp-block-group\"><!-- wp:heading {\"level\":3} -->\r\n<h3 id=\"titolo-e-punto-elenco-1\">Quando inizia il corso?</h3>\r\n<!-- /wp:heading -->\r\n\r\n<!-- wp:spacer {\"height\":24} -->\r\n<div style=\"height:24px\" aria-hidden=\"true\" class=\"wp-block-spacer\"></div>\r\n<!-- /wp:spacer -->\r\n\r\n<!-- wp:paragraph -->\r\n<p>La prossima pizzaclass comincera a breve, affrettati e non perderai gli ultimi posti disponibili.</p>\r\n<!-- /wp:paragraph -->\r\n\r\n<!-- wp:list -->\r\n<ul><li>01/02/2022</li><li>01/02/2022</li><li>01/02/2022</li><li>01/02/2022</li></ul>\r\n<!-- /wp:list -->\r\n\r\n<!-- wp:spacer -->\r\n<div style=\"height:100px\" aria-hidden=\"true\" class=\"wp-block-spacer\"></div>\r\n<!-- /wp:spacer --></div>\r\n<!-- /wp:group -->",
