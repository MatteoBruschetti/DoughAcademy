...
--------------------------------------------------*/
    ...
    function DA_custom_corsi() {
        register_post_type( 'corsi',
            array(
                ...
                'description'           =>          'I corsi Pizza Class di Dough Academy',
                'public'                =>          true,
    ...
    add_action( 'init', 'DA_custom_corsi');

    //aggiunta categorie
    function DA_corsi_taxonomies() {
        register_taxonomy(
            'categoria_tag',
            'corsi',
            array(
    ...
    add_action( 'init', 'DA_corsi_taxonomies', 0 );



    /*SHORTCODE
    -----------------------------*/
    add_shortcode( 'corsi', 'DA_display_corsi_custom_post_type' );

    function DA_display_corsi_custom_post_type($atts){
        ob_start();
                    ...
                    <div class="col-12">
                        ...
                        <div class="row justify-content-center">
                            <div class="col-3 col-lg-2 casa">
                                <!--Facebook-->
                                <a href="<?php echo get_theme_mod("DA_social_facebook"); ?>" target="_blank">
                            ...
                            <div class="col-3 col-lg-2 casa">
                                <!--Instagram-->
                                <a href="<?php echo get_theme_mod("DA_social_instagram"); ?>" target="_blank">
                                    <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <circle cx="22" cy="22" r="22" class="svg-social-icon-bg"/>
                            ...
                            <div class="col-3 col-lg-2 casa">
                                <!--Youtube-->
                                <a href="<?php echo get_theme_mod("DA_social_youtube"); ?>" target="_blank">
                                    <svg width="44" height="44" viewBox="0 0 44 44" fill="none" xmlns="http://www.w3.org/2000/svg">
                                        <circle cx="22" cy="22" r="22" class="svg-social-icon-bg"/>
