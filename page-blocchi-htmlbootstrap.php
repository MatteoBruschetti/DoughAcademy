<!------------------------------------------------------------------
    THIS IS THE PAGE with all the aviable html blocks
-------------------------------------------------------------------->
<?php get_header(); ?>
    ...
    <div class="container pb-s pt-s" >
        ...
        <p style="color:red">BLOCCO Titolo + paragrafo</p>
        ...
        <p style="color:red">BLOCCO Keypoints img + titolo + p</p>
        ...
        <p style="color:red">BLOCCO Fascia in evidenza</p>
        ...
        <p style="color:red">BLOCCO Social bar</p>
        <!--BLOCCO Social bar-->
