    ...
    <div class="container pb-s pt-s" >
        ...
        <section class="hero">
            <div class="row align-items-center mb-xl">
                <div class="col-12">
                    ...
                    <a class="btn btn-center-mobile mt-m casa" href="<?php echo get_permalink( get_page_by_path( 'pizza-class' ) ); ?>">Scopri i corsi</a>
                </div>
            </div>
        </section>
        ...
        <section class="fascia-evidenza fascia-evidenza__dark mb-xxl">
            <div class="row t-center">
                ...
                <div class="col-12">
                    <a class="btn mt-l casa" href="<?php echo get_permalink( get_page_by_path( 'pizza-class' ) ); ?>">Scopri i corsi</a>
                </div>
                <div class="col-12">
